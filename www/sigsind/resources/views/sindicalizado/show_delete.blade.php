...
@section('content')
    ...
    <div class="panel panel-widget">
        ...
        <div class="sind-dados col-md-12">
            ...
            <div class="col-md-2">
                <a href="sindicalizado/lista" class="btn btn_5 btn-lg btn-primary">Cancelar</a>
            </div>
            <div class="col-md-2">
                <a href="sindicalizado/excluir/{{$sindicalizado->id}}" class="btn btn_5 btn-lg btn-primary" onclick="return confirm('Deseja realmente excluir este sindicalizado da base de dados?');" >Deletar</a>
            </div>
